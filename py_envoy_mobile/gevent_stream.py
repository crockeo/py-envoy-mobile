...
class GeventStream:
    ...
    def __init__(self, engine: wrapper.Engine):
        ...
        self.headers_result = AsyncResult()

        self.data_value = bytearray()
        self.data_result = AsyncResult()

        self.metadata_value: Dict[str, str] = {}
        self.metadata_result = AsyncResult()

        self.trailers_value: Dict[str, str] = {}
        self.trailers_result = AsyncResult()

        self.status_result = AsyncResult()

    def headers(self) -> Dict[str, str]:
        return self.headers_result.get()  # type: ignore

    def data(self) -> bytes:
        return self.data_result.get()  # type: ignore

    def metadata(self) -> Dict[str, str]:
        return self.metadata_result.get()  # type: ignore

    def trailers(self) -> Dict[str, str]:
        return self.trailers_result.get()  # type: ignore

    def status(self) -> Status:
        return self.status_result.get()  # type: ignore
